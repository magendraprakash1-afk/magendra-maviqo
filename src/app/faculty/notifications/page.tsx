...
import { Bell, FileText, CheckCircle2, Calendar, Award, CheckCheck, Users } from "lucide-react";

export default function FacultyNotificationsPage() {
  const [notifications, setNotifications] = useState<NotificationItem[]>(() =>
    DataStore.getNotifications("faculty")
  );

  useEffect(() => {
    const handleSync = () => {
      setNotifications(DataStore.getNotifications("faculty"));
    };
    ...
    <div className="space-y-6 pb-20 lg:pb-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <PageHeader
          ...
          subtitle="Department briefings, examination duties, academic deadlines, and circulars"
        />
        {unreadCount > 0 && (
          <button
            onClick={() => DataStore.markAllNotificationsRead("faculty")}
